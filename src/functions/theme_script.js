...
{	
	...
	jQuery("#content_builder_sort li a.ppb_duplicate").on( 'click', function(){
	    ...
	    builderItem+= '<div class="size"><a href="#" class="ppb_plus button">+</a>';
	    builderItem+= '<a href="#" class="ppb_minus button">-</a></div>';
	    ...
	    builderItem+= '<a href="#" class="ppb_remove"><i class="fa fa-trash"></i></a>';
...
jQuery(document).ready(function(){
	...
	jQuery("#ppb_module_wrapper li").on( 'click', function(){
	    ...
	    if(myCheckId != '' && targetType == 'module')
	    {
	    	...
	    	builderItem+= '<a data-rel="'+randomId+'" href="#" class="ppb_add_after"><i class="fa fa-plus"></i></a>';
			...
			jQuery.ajax({
			  ...
			  success: function (data) {
			    ...
			    if(data != '')
			    {
					...
					newTemplateHTMLBlock+= '<a href="#" class="confirm_import"><div class="builder_title">'+newTemplateName+'</div></a>';
